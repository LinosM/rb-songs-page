        ...
        <section className="section content">
            <div className="container pt-5 has-text-light">
                ...
                <div className="has-text-centered">
                    ...
                    <a href="https://github.com/LinosM/rb-songs-page" className="has-text-light is-underlined">https://github.com/LinosM/rb-songs-page</a>
                </div>
            </div>
        </section>
    );
